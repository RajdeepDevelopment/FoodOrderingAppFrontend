...
const AmChartTimeFrame = () => {
  ...
  useEffect(()=>{
    ...
    am4core.ready(function() {
        let chart = am4core.create("TimeLineFrame", am4plugins_timeline.CurveChart);
        ...
        dateAxis.max = new Date(2019, 2, 11, 7, 10).getTime();    
  ...
  return (
    <div className='bhag container' >
      <div style={{height: "500px", width:"100%"}} id="TimeLineFrame"> 
...
export default AmChartTimeFrame
